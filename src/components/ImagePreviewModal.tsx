...
export function ImagePreviewModal({
  ...
  // Web Share API (especially useful on iOS / Android)
          ...
          <div className="flex items-start gap-2.5">
            ...
            <div className="text-xs sm:text-sm text-amber-900">
              ...
              <p className="mt-0.5 leading-relaxed text-amber-800">
                👉 <strong>Chạm và giữ (long-press)</strong> vào ảnh bên dưới → chọn <span className="bg-amber-200/80 px-1.5 py-0.5 rounded font-bold text-amber-950">"Lưu vào Ảnh" (Save to Photos)</span> hoặc <span className="bg-amber-200/80 px-1.5 py-0.5 rounded font-bold text-amber-950">"Chia sẻ"</span> để gửi qua Zalo / Tin nhắn.
              </p>
